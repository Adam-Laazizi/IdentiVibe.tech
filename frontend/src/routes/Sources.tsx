  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-3xl mx-auto py-8 px-4">
        ...
        <h1
          className="text-5xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-violet-400 via-fuchsia-300 to-cyan-400 mb-8"
          style={{
        ...
        <div className="space-y-5 mb-8">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-900/80 backdrop-blur-sm border border-violet-500/30 rounded-2xl p-6 hover:border-red-400/50 transition-all duration-300">
              <label
                className="block text-xs font-bold text-violet-300 uppercase tracking-widest mb-4"
                style={{
                  fontFamily: '"Fira Code", monospace',
        ...
        {saveError && (
          <div className="mb-4 p-4 bg-red-950/50 backdrop-blur-sm border border-red-500/50 rounded-xl">
            <p
